...
startBtn.Size = UDim2.new(0.8,0,0,btnHeight)
startBtn.Position = UDim2.new(0.1,0,0,70)
startBtn.Text = "AUTO OFF"
startBtn.BackgroundColor3 = Color3.fromRGB(200,60,60)
startBtn.TextColor3 = Color3.new(1,1,1)
startBtn.TextSize = btnFontSize
...
local function getNearestEnemy()
    ...
    for _,v in pairs(workspace:GetDescendants()) do
        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
            if v.Humanoid.Health > 0 and v ~= character then
